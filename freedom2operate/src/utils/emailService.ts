...
export const sendSubmissionEmail = async (data: EmailData): Promise<void> => {
  ...
  const msg = {
    ...
    subject: `Freedom to Operate Search Request - ${projectName}`,
    text: `Thank you for submitting your Freedom to Operate search request.\n\nProject: ${projectName}\nReference Number: ${referenceNumber}\n\nWe have attached a PDF copy of your submission for your records.\n\nOur team will review your submission and contact you soon.`,
    html: `
      <h2>Freedom to Operate Search Request</h2>
      <p>Thank you for submitting your Freedom to Operate search request.</p>
...
export const sendAdminNotification = async (projectData: {
  ...
  const msg = {
    ...
    text: `
      New Freedom to Operate search request received.
    ...
    `,
    html: `
      <h2>New Freedom to Operate Search Request</h2>
